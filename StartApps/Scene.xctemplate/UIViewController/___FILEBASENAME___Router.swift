...
class ___FILEBASENAMEASIDENTIFIER___Router {
    ...
    func passDataToSomewhereScene(segue: UIStoryboardSegue) {
        ...
        // someWhereViewController.interactor.name = viewController.interactor.name
        
        // In case of UITableView selection use the following code
        // if let selectedIndexPath = viewController.tableView.indexPathForSelectedRow {
        //     if let selectedItem = viewController.interactor.items?[selectedIndexPath.row] {
        //         let showItemViewController = segue.destination as! ShowItemViewController
        //         showItemViewController.interactor.someItem = selectedItem
        //     }
        // }
    }
